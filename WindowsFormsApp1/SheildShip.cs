...
{
    class SheildShip:Ship
    {
        public SheildShip(int x, int y,double phaseOffset, int width= 5, int height=5, int speed=3, int coolDownTime=3, int hp=50, string shipWeapon= "Bullet") :base(x, y, 5, 5, 3, 3, hp, "Bullet")
        {
            phase = phaseOffset;
        }
